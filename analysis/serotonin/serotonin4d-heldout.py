...
@click.option('--results_dir', default="/home/groups/swl1/swl1/dirichlet-tucker/analysis/serotonin/results/2024_07_01-12_00-heldout", help='path to folder where results are stored.')
...
def run_sweep(data_dir, 
    ...
    # Load the data
    data, drugs = load_data(data_dir)
    num_mice, num_epochs, _, _ = data.shape
    ...
    model, params, lps = fit_model(init_key, 
                                   train_data, 
                                   jnp.ones((len(train_data), num_epochs), dtype=bool), 
                                   km, 
                                   kn, 
                                   kp, 
                                   ks, 
