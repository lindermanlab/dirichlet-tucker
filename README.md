...
## Installation
This example installation script installs the GPU-version of JAX.
For CPU installation and latest installation, see the [JAX installation page](https://jax.readthedocs.io/en/latest/installation.html).
```shell
# -----------------------------------------------
...
pip install hydra-core optax pathlib tensorflow-probability tqdm wandb
...
The full package list with exact package versions used are found in `requirements.txt`, which is generated by running
```
